...
A számítási egységek: a magok száma, az elemek feldolgozása ALU magonként történik.
...
Az OpenCL megkülönböztet eszköz és feldolgozási modelleket. A következőkben ezeket, továbbá a munkacsoportok létrehozását láthatjuk.
...
Egy OpenCL program fejlesztése a következő lépésekből áll \cite{opencl}.
\begin{itemize}
