...
A vizsgált kódrészlet: (gantt-hez programok, gantt. grafikonokhoz programok, global\_size\_speed)
\begin{python}  
timer.start();
...
A diagram előállításához használt kód megtalálható a programok, gantt mappában
...
0.5\% os visszatérési arany esetében ha nincs indexelés, akkor 7 lekérdezés után megtérülhetnek az \texttt{OpenCL} plusz költségei.
Ha van indexelés abban az esetben ez a szám eléri a 37 -et.\newline
